...
public class DestinationStepPage {
    ...
    public DestinationStepPage clickContainerSelector() {
    ...
    public DestinationStepPage clickTargetStorageSelector() {
    ...
    public DestinationStepPage clickPoolSelector() {
